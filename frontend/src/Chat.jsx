...
export default function Chat() {
    ...
    return ( 
        <>
            ...
            <div className="chats">
                {/* Now we will firstly display all the previous chats except this curr chat here if they exists */}
                        ...
                        <div className={chat.role === "user" ? "userDiv" : "groqDiv"}  key={idx}>
                            {
                                ...
                                <p className="groqMessage">{chat.content}</p>
                            }
                        </div>
                    ))
                }
                ...
                {/* Now we will display this last chat i.e this curr chat here if it exists */}
                {/* {
                    prevChats.length > 0 && (
                        <> 
                            {
